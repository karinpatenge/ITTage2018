...
public class BasicTableExample {
    private static final String createTableStatement =
        "create table if not exists ittage(id integer, " +
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            MapValue value = new MapValue().put("id", 1).put("name", "Karin");
            ...
            /* construct a simple row */
            final String jsonString = "{\"id\": 2, \"name\":\"Emma\"}";
            ...
            QueryRequest queryRequest = new QueryRequest().
                setStatement("select * from ittage where name = \"Karin\"");
            ...
            output("BasicTableExample: delete user with key = " + key.toString());
